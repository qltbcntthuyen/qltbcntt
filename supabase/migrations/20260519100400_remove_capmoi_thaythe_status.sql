-- =============================================
-- VIEW v_bao_cao_chung_thu_so: bo trang thai 'da_thay_the' va 'can_cap_moi'
-- Theo gop y: sau khi cap thiet bi, CTS chi con: doi thong tin, gia han, thu hoi.
-- CTS bi thay the / het han se gom ve het_han / sap_het_han / dang_hieu_luc theo ngay.
-- =============================================
...
comment on view public.v_bao_cao_chung_thu_so is
  'View bao cao CTS; bo trang thai da_thay_the va can_cap_moi theo gop y.';
